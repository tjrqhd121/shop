...
<div class="info">
    <form class="login" method="post" id="frm">
        <h1 class="login-title">회원정보수정</h1>
			...
			<button type="button" onclick="DosignUp()" class="login-button" style="width: 130px;">회원정보수정</button>
			<button type="button" onclick="Dodelete()" class="login-button" style="margin-top: 0px;width: 130px;margin-left: 34px;">회원탈퇴</button>
    </form>
</div>
